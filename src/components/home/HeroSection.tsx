...
const heroMetadata = {
  ...
  name: 'Justin\nClarke',
  bio: 'Pipelines to dashboards. Engineering to insight.',
  cta: 'Get in touch',
};
    ...
    >
      ...
      <div className={cn(
        ...
        <div className="flex flex-col items-start text-left px-6 md:px-0">
          ...
          <motion.p
            className="font-ibm text-sm font-normal text-black/60 tracking-widest mb-3 uppercase"
          ...
          <motion.h1
            className="font-serif font-normal text-black leading-[1.1] mb-6 md:mb-8 whitespace-pre-line tracking-tight max-w-2xl"
          ...
          <motion.p
            className="font-noto text-base font-normal text-black/70 leading-relaxed max-w-[460px] mb-5"
            variants={HERO_CONTENT_REVEAL}
            initial="hidden"
            animate="visible"
            custom={0.6}
