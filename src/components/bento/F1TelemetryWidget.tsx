...
export function F1TelemetryWidget() {
  ...
  return (
    <div data-theme-lock="dark" className="flex flex-col h-full justify-between gap-1.5 md:gap-2 select-none text-left">
      ...
      <div className={cn(
        ...
        {[
          ...
          <Fragment key={stage.label}>
            ...
            >
              <span className="text-[10px] md:text-[11px] leading-none shrink-0">{stage.icon}</span>
              <span className="font-mono text-[8.5px] md:text-[10px] font-black tracking-[0.08em] leading-none shrink-0">{stage.label}</span>
            </div>
            {i < arr.length - 1 && (
      ...
      {/* Footer metrics */}
      <div className="flex flex-wrap gap-x-3 gap-y-1 justify-between items-center pt-1.5 text-neutral-400 font-mono text-[9px] md:text-[10px] shrink-0">
