...
export const Badge: React.FC<BadgeProps> = ({
  ...
  // Auto-detect tooltip from children if not provided
  const tooltipText = tooltip || (typeof children === 'string' ? TOOLTIPS[children.toLowerCase().replace(/[\s\/]/g, '') as keyof typeof TOOLTIPS] : undefined);
