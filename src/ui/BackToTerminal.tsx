 ...
 *
 * For beginners ----------------------------------------------------------------
 * `<Link to="/">` is react-router's version of an `<a href="/">`. It navigates
 * without a full page reload, which keeps the app fast.
 * -----------------------------------------------------------------------------
 */
