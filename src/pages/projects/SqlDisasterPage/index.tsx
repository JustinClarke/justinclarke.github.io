      ...
      <section className="py-20 md:py-32 px-6 md:px-12 bg-[#080808] text-white border-y border-white/5 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            {/* Code block */}
            <ScrollReveal direction="left">
              <div className="p-6 md:p-10 bg-brand-card border border-white/8 rounded-[28px] font-mono text-[11px] md:text-[13px] leading-relaxed overflow-x-auto shadow-2xl">
