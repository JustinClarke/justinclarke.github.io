 ...
 * Note:    the interactive D3 graph is rendered by the SqlErd component - a
 *          separate file that injects a plain JavaScript file at mount time
 *          (no React inside it).
 */
...
export const SqlDisasterPage = () => {
  ...
  return (
    ...
    >
      <SEO {...routeMeta('/project/sql-disaster')} />
      ...
      >
        <div className="px-5 py-2 rounded-full border border-white/10 bg-black/40 backdrop-blur-xl flex items-center gap-5 shadow-2xl">
          <span className="font-mono text-micro tracking-ultra uppercase text-text-tertiary font-bold">
          ...
          <span className="font-mono text-micro tracking-ultra uppercase text-text-ghost">Module: DIS-REL-PH</span>
          <div className="w-px h-3 bg-white/20" aria-hidden="true" />
          <span className="flex items-center gap-2 text-red-500 font-mono text-micro tracking-ultra uppercase font-black">
      ...
      {/* ════════════════════════════════════════════════════════════════
          HERO
      ════════════════════════════════════════════════════════════════ */}
      <section className="relative h-screen flex flex-col items-center justify-center px-6 md:px-24 overflow-hidden bg-brand-bg text-white">
        ...
        <div className="relative z-10 max-w-7xl w-full text-center">
          <ScrollReveal direction="up">
            ...
            <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-[4px] border border-red-500/30 bg-red-500/10 backdrop-blur-md mb-10">
              ...
              <span className="font-mono text-micro md:text-micro tracking-[0.6em] uppercase font-black text-red-500">
            ...
            {/* Descriptor */}
            <p className="font-mono text-base md:text-2xl text-text-tertiary max-w-3xl mx-auto leading-relaxed mb-10 px-4">
              Modelled coordination for{' '} <br />
              <span className="text-text-secondary underline decoration-red-600 underline-offset-[10px] decoration-[1.5px]">
                Philippine relief operations <br />
              </span>{' '}
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-12">
              {['MySQL', 'D3.js v7', 'Vanilla JS', 'Force Graph', 'CTE + Window Functions'].map(tag => (
                <span
                  key={tag}
                  className="font-mono text-micro tracking-widest uppercase px-3 py-1 border border-white/10 rounded-full text-text-tertiary"
                >
                  {tag}
                </span>
              ))}
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-20">
          <span className="font-mono text-micro tracking-[0.4em] uppercase">Scroll</span>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-4 md:grid-cols-7 divide-x divide-white/5">
          {ENTITY_REGISTRY.map(entity => (
            <div key={entity.id} className="flex flex-col items-center justify-center py-6 px-4 gap-1.5 group">
              ...
              <span className="font-mono text-micro tracking-ultra uppercase text-text-ghost group-hover:text-text-tertiary transition-colors">
                {entity.label}
              </span>
            </div>
          ))}
      ...
      ════════════════════════════════════════════════════════════════ */}
      <section className="py-20 md:py-32 px-6 md:px-12 bg-brand-bg text-white relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          <ScrollReveal direction="up">
            <div className="flex flex-col items-center text-center gap-5 mb-16 md:mb-20">
              <span className="font-mono text-red-500 text-fine tracking-[0.5em] uppercase font-black">System Architecture</span>
              <h2 className="font-noto text-4xl md:text-8xl font-black tracking-tighter uppercase leading-none">
                Relational<br />
                <span className="text-text-dim">Blueprint.</span>
              </h2>
              <p className="font-mono text-sm md:text-base text-text-tertiary max-w-xl leading-relaxed">
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 mb-12">
              {ENTITY_REGISTRY.map(e => (
                <div key={e.id} className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-micro tracking-widest uppercase text-text-tertiary">{e.label}</span>
                </div>
              ))}
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
              {SQL_METRICS.map(m => (
                <div key={m.label} className="p-5 border border-white/5 rounded-2xl bg-white/[0.02] flex flex-col gap-1">
                  ...
                  <span className="font-mono text-micro tracking-widest uppercase text-text-tertiary">{m.label}</span>
                  <span className="font-mono text-micro text-text-tertiary">{m.sub}</span>
                </div>
              ))}
            </div>
          </ScrollReveal>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-28 items-center">
          ...
          <ScrollReveal direction="left">
            <div className="flex flex-col gap-6">
              <span className="font-mono text-red-500 text-fine tracking-[0.5em] uppercase font-black">Data Modeling</span>
              <h2 className="font-noto text-5xl md:text-7xl font-black tracking-tighter uppercase leading-none">
                Schema<br />
                <span className="text-text-dim">Rigor.</span>
              </h2>
              <p className="font-mono text-sm md:text-base text-text-tertiary leading-relaxed max-w-md">
              ...
              <div className="grid grid-cols-3 gap-4 mt-4">
                {[
                  ...
                  <div key={stat.l} className="flex flex-col gap-1">
                    ...
                    <span className="font-mono text-micro tracking-widest uppercase text-text-tertiary">{stat.l}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <ScrollReveal direction="right">
            <div className="relative p-px rounded-[36px] bg-gradient-to-br from-red-500/20 via-white/5 to-transparent">
              <div className="bg-brand-card rounded-[35px] p-8 md:p-10 flex flex-col gap-4 border border-white/5">
                <div className="font-mono text-micro tracking-[0.4em] uppercase font-black text-red-500/50 mb-2">
                ...
                {SCHEMA_FEATURES.map(item => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-mono text-micro text-white uppercase font-black tracking-widest">{item.t}</span>
                    </div>
                    <span className="font-mono text-micro text-text-tertiary leading-relaxed">{item.d}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      ════════════════════════════════════════════════════════════════ */}
      <section className="py-20 md:py-28 px-6 md:px-12 bg-brand-bg text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up">
            <div className="flex flex-col items-center text-center gap-5 mb-16">
              <span className="font-mono text-sql-agency text-fine tracking-[0.5em] uppercase font-black">Visualization Engine</span>
            ...
            {ENGINE_STATS.map((stat, i) => (
              <ScrollReveal key={stat.label} direction="up">
                <div className="p-6 md:p-8 border border-white/5 rounded-2xl bg-white/[0.02] flex flex-col gap-2 hover:border-sql-agency/20 hover:bg-sql-agency/5 transition-all duration-300 group">
                  ...
                  <span className="font-mono text-micro tracking-widest uppercase text-text-tertiary">{stat.label}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={f.title} className="p-6 border border-white/5 rounded-2xl bg-white/[0.02] hover:border-sql-agency/15 transition-all duration-300">
                  ...
                  <div className="font-mono text-fine tracking-widest uppercase font-black text-white mb-2">{f.title}</div>
                  <div className="font-mono text-micro text-text-tertiary leading-relaxed">{f.desc}</div>
                </div>
              ))}
            </div>
          </ScrollReveal>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <ScrollReveal direction="up">
            <div className="flex flex-col items-center text-center mb-16 gap-5">
              <span className="font-mono text-red-500 text-fine tracking-[0.5em] uppercase font-black">Analytical Breadth</span>
              <h2 className="font-noto text-5xl md:text-[8rem] font-black tracking-tighter uppercase leading-none">
                The Query<br />
                <span className="text-text-dim">Syllabus.</span>
              </h2>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            {/* Code block */}
            <ScrollReveal direction="left">
              <div className="p-6 md:p-10 bg-brand-card border border-white/8 rounded-[28px] font-mono text-fine md:text-label leading-relaxed overflow-x-auto shadow-2xl">
                <div className="flex items-center gap-2 mb-8">
                  <div className="w-2.5 h-2.5 rounded-full bg-red-500/60" />
                  <div className="w-2.5 h-2.5 rounded-full bg-white/10" />
                  <div className="w-2.5 h-2.5 rounded-full bg-white/10" />
                  <span className="ml-4 text-micro uppercase tracking-widest font-black text-text-tertiary">
                    shelter_stress_tier.sql
                  </span>
                </div>
                <code className="block whitespace-pre text-red-400/70">
                  <span className="text-text-tertiary">WITH</span>{' '}ShelterMetrics{' '}<span className="text-text-tertiary">AS (</span>{'\n'}
                  {'  '}<span className="text-text-secondary">SELECT</span> name, capacity,{'\n'}
                  {'    '}(occupancy / capacity) * 100{' '}<span className="text-text-secondary">AS</span> stress_pct{'\n'}
                  {'  '}<span className="text-text-secondary">FROM</span> Shelters{'\n'}
                  <span className="text-text-tertiary">)</span>{'\n'}
                  <span className="text-text-secondary">SELECT</span> name, stress_pct,{'\n'}
                  {'  '}<span className="text-text-secondary">NTILE</span>(3){' '}
                  <span className="text-text-secondary">OVER</span> (<span className="text-text-secondary">ORDER BY</span> stress_pct{' '}
                  <span className="text-text-secondary">DESC</span>){' '}<span className="text-text-secondary">AS</span> stress_tier{'\n'}
                  <span className="text-text-secondary">FROM</span> ShelterMetrics;{'\n'}
                  {'\n'}
                  <span className="text-text-ghost">{'-- '}Identifies high-risk evacuation zones</span>{'\n'}
                  <span className="text-text-ghost">{'-- '}Shelter 8 Bicol: 99% · Shelter 1 Manila: 96%</span>
                </code>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="right">
              <div className="flex flex-col gap-8">
                <p className="font-mono text-base md:text-lg text-text-tertiary leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {QUERY_CATEGORIES.map((cat, i) => (
                    <div key={cat} className="flex items-center gap-3 group">
                      <span className="font-mono text-micro text-red-600/50 w-4 flex-shrink-0 group-hover:text-red-400 transition-colors">
                        {String(i + 1).padStart(2, '0')}
                      </span>
                      <span className="font-mono text-micro text-text-tertiary uppercase tracking-widest font-black group-hover:text-text-secondary transition-colors">
                        {cat}
                      </span>
                    </div>
                  ))}
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up">
            <div className="flex flex-col items-center text-center gap-8 md:gap-10 mb-16 md:mb-20">
              <span className="font-mono text-black/25 text-micro tracking-[0.6em] uppercase font-black">
            ...
            <div className="relative w-full max-w-4xl mx-auto rounded-[28px] md:rounded-[36px] overflow-hidden shadow-[0_40px_120px_rgba(0,0,0,0.25)] bg-[rgb(5,8,15)] border border-white/10">
              ...
              <div className="h-10 bg-[rgb(11,17,32)] border-b border-white/5 flex items-center px-5 justify-between">
                ...
                <div className="font-mono text-micro tracking-ultra uppercase text-text-dim">
                  ROOT@COORD_DASHBOARD ~ /LIVE_SESSION
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse" />
                  <span className="font-mono text-micro text-red-500/60 uppercase tracking-widest">MT. KANLAON ACTIVE</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-7 border-b border-white/5">
                {ENTITY_REGISTRY.map(e => (
                  <div key={e.id} className="flex flex-col items-center py-3 gap-0.5">
                    ...
                    <span className="font-mono text-micro tracking-widest uppercase text-text-tertiary">{e.id}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="flex items-center justify-center py-20 md:py-28 relative overflow-hidden">
                ...
                <div className="flex flex-col items-center gap-6 z-10 text-center px-6">
                  <div className="font-mono text-xs tracking-ultra uppercase text-text-tertiary mb-2">
                  ...
                  <span className="font-mono text-micro text-text-dim uppercase tracking-widest">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 divide-x divide-white/5">
          {[
            ...
            <div key={stat.l} className="flex flex-col items-center justify-center py-10 px-4 gap-1.5 text-center">
              ...
              <span className="font-mono text-micro tracking-widest uppercase text-text-tertiary">{stat.l}</span>
              <span className="font-mono text-micro text-text-dim">{stat.d}</span>
            </div>
          ))}
        </div>
      </div>
