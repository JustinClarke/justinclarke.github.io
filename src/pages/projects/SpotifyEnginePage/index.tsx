...
const Label = ({ children, green = false }: { children: React.ReactNode; green?: boolean }) => (
  <span className={cn(
    ...
    green ? 'text-viz-spotify' : 'text-white/25'
  )}>
            ...
            >
              <MagneticButton as="div">
                <a
                  ...
                  className="px-8 md:px-10 py-4 rounded-2xl bg-viz-spotify text-black font-mono text-[11px] font-black tracking-widest uppercase shadow-[0_0_40px_rgba(29,185,84,0.3)] hover:shadow-[0_0_64px_rgba(29,185,84,0.45)] transition-shadow block text-center"
                >
                  Read Project Report
                </a>
              </MagneticButton>
            ...
            <div className="relative rounded-[28px] overflow-hidden bg-[#0a0a0a] border border-white/[0.07] shadow-[0_24px_80px_rgba(0,0,0,0.6)]">
              ...
              <div className="p-7 md:p-10 overflow-x-auto">
                <code className="font-mono text-[11px] md:text-[13px] text-white/40 leading-[1.9] block whitespace-pre">
                  ...
                  <span className="text-white/15 select-none">09  </span>sim2 = <span className="text-viz-spotify">cosine_similarity</span>(pop_vecs,   query_pop){'\n'}
                  <span className="text-white/15 select-none">10  </span>sim3 = <span className="text-viz-spotify">cosine_similarity</span>(genre_tfidf, query_genre){'\n'}
