...
const TERM_LABELS: Record<TermKey, React.ReactNode> = {
  ...
  skill:    <span>ε<sub>i</sub> <span className="text-micro opacity-70">(driver)</span></span>,
};
    ...
    >
      ...
      {term === 'fuel' && (
        <>
          ...
          {/* Labels */}
          <text x="35" y="44" className="font-jetbrains text-micro fill-white/40 text-end">+3.3s</text>
          <text x="35" y="179" className="font-jetbrains text-micro fill-white/40 text-end">0.0s</text>
          <text x="40" y="192" className="font-jetbrains text-micro fill-white/40">110kg (Start)</text>
          <text x="360" y="192" className="font-jetbrains text-micro fill-white/40 text-end">0kg (End)</text>
          <text x="200" y="210" className="font-jetbrains text-micro fill-white/60 font-bold text-center" textAnchor="middle">FUEL LOAD vs LAP TIME PENALTY</text>
        </>
      )}
      ...
      {term === 'compound' && (
        <>
          ...
          <text x="275" y="55" className="font-jetbrains text-micro fill-f1-red font-bold">TYRE CLIFF</text>
          
          {/* Labels */}
          <text x="35" y="34" className="font-jetbrains text-micro fill-white/40 text-end">+4.5s</text>
          <text x="35" y="179" className="font-jetbrains text-micro fill-white/40 text-end">0.0s</text>
          <text x="40" y="192" className="font-jetbrains text-micro fill-white/40">L0 (New)</text>
          <text x="360" y="192" className="font-jetbrains text-micro fill-white/40 text-end">L40 (Cliffed)</text>
          <text x="200" y="210" className="font-jetbrains text-micro fill-white/60 font-bold text-center" textAnchor="middle">TYRE AGE vs PACE LOSS (CLIFF PROFILE)</text>
        </>
      )}
      ...
      {term === 'rubber' && (
        <>
          ...
          />
          {/* Labels */}
          <text x="35" y="44" className="font-jetbrains text-micro fill-white/40 text-end">0.0s</text>
          <text x="35" y="159" className="font-jetbrains text-micro fill-white/40 text-end">-1.2s</text>
          <text x="40" y="192" className="font-jetbrains text-micro fill-white/40">Session Start</text>
          <text x="360" y="192" className="font-jetbrains text-micro fill-white/40 text-end">Session End</text>
          <text x="200" y="210" className="font-jetbrains text-micro fill-white/60 font-bold text-center" textAnchor="middle">TRACK RUBBER EVOLUTION (GRIP GAIN)</text>
        </>
      )}
      ...
      {term === 'ambient' && (
        <>
          ...
          <path
            ...
            className="animate-draw"
          />
          <text x="225" y="60" className="font-jetbrains text-micro fill-f1-red font-bold">TEMP</text>
          <text x="225" y="160" className="font-jetbrains text-micro fill-viz-info font-bold">AIR DENSITY</text>
          
          {/* Labels */}
          <text x="35" y="44" className="font-jetbrains text-micro fill-white/40 text-end">Max</text>
          <text x="35" y="179" className="font-jetbrains text-micro fill-white/40 text-end">Min</text>
          <text x="40" y="192" className="font-jetbrains text-micro fill-white/40">Race Start</text>
          <text x="360" y="192" className="font-jetbrains text-micro fill-white/40 text-end">Finish</text>
          <text x="200" y="210" className="font-jetbrains text-micro fill-white/60 font-bold text-center" textAnchor="middle">WEATHER VARIABLES & THERMAL EFFICIENCY</text>
        </>
      )}
      ...
      {term === 'car' && (
        <>
          ...
          <text x="208" y="130" className="font-jetbrains text-micro fill-viz-info font-bold">PACE DELTA</text>

          {/* Labels */}
          <text x="35" y="90" className="font-jetbrains text-micro fill-white/40 text-end">Faster</text>
          <text x="35" y="179" className="font-jetbrains text-micro fill-white/40 text-end">Slower</text>
          <text x="40" y="192" className="font-jetbrains text-micro fill-white/40">Stint Lap 0</text>
          <text x="360" y="192" className="font-jetbrains text-micro fill-white/40 text-end">Stint Lap 20</text>
          <text x="200" y="210" className="font-jetbrains text-micro fill-white/60 font-bold text-center" textAnchor="middle">TEAMMATE PANEL CONSTRUCTOR PACE DELTA</text>
        </>
      )}
      ...
      {term === 'air' && (
        <>
          ...
          <text x="61" y="64" className="font-jetbrains text-micro fill-black font-extrabold text-center" textAnchor="middle">CAR1</text>
          ...
          <text x="231" y="64" className="font-jetbrains text-micro fill-white font-extrabold text-center" textAnchor="middle">CAR2</text>
          ...
          {/* Labels */}
          <text x="35" y="134" className="font-jetbrains text-micro fill-white/40 text-end">+1.8s</text>
          <text x="35" y="179" className="font-jetbrains text-micro fill-white/40 text-end">0.0s</text>
          <text x="100" y="192" className="font-jetbrains text-micro fill-white/40">0.5s Gap</text>
          <text x="340" y="192" className="font-jetbrains text-micro fill-white/40 text-end">3.0s Gap</text>
          <text x="200" y="210" className="font-jetbrains text-micro fill-white/60 font-bold text-center" textAnchor="middle">WAKE DYNAMICS & DISTANCE-BASED TAX</text>
        </>
      )}
      ...
      {term === 'skill' && (
        <>
          ...
          <text x="110" y="90" className="font-jetbrains text-micro fill-f1-red font-bold">DRIVER GAIN</text>
          ...
          <text x="204" y="65" className="font-jetbrains text-micro fill-white/40">MEAN (0.0s)</text>

          {/* Labels */}
          <text x="35" y="179" className="font-jetbrains text-micro fill-white/40 text-end">0.0</text>
          <text x="40" y="192" className="font-jetbrains text-micro fill-white/40">-0.8s (Faster)</text>
          <text x="360" y="192" className="font-jetbrains text-micro fill-white/40 text-end">+0.8s (Slower)</text>
          <text x="200" y="210" className="font-jetbrains text-micro fill-white/60 font-bold text-center" textAnchor="middle">DRIVER SKILL RESIDUAL DISTRIBUTION</text>
        </>
      )}
    </svg>
  );
    ...
    <section id={id} className="w-full scroll-mt-32 reveal-element">
      <div className="max-w-6xl mx-auto py-16">
        ...
        <div className="bg-graphite-800/20 border border-white/5 p-6 rounded-xl">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 pb-4 border-b border-white/[0.08] font-jetbrains text-micro uppercase tracking-widest text-text-tertiary">
            <div className="flex items-center gap-2">
              ...
              <span className="text-text-primary font-bold">Interactive Model</span>
              <span className="text-text-ghost hidden sm:inline">|</span>
              <span className="hidden sm:inline text-text-tertiary">Click any term to inspect its live causal estimation &amp; graph</span>
            </div>
          ...
          <div
            ...
            className="flex items-center justify-start xl:justify-center gap-1.5 md:gap-3 font-jetbrains text-fine sm:text-xs md:text-sm select-none overflow-x-auto whitespace-nowrap w-full pb-6 pt-2 scrollbar-none"
            style={{
              scrollbarWidth: 'none',
          ...
          >
            ...
            <span className="text-text-tertiary shrink-0 text-sm md:text-base">=</span>
                    ...
                    className={`px-3 py-2 md:px-4 md:py-2.5 border rounded font-jetbrains transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-f1-red/80 cursor-pointer select-none shrink-0 flex items-center justify-center relative overflow-hidden group ${
                      isSelected
                        ...
                        : isSkill
                          ...
                          : 'border-white/20 bg-white/5 text-text-secondary hover:border-white/60 hover:bg-white/10 hover:text-white hover:shadow-[0_0_15px_rgba(255,255,255,0.15)] hover:-translate-y-[2px]'
                    }`}
                  >
                    {!isSelected && (
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-8 border-l-2 border-f1-red bg-white/[0.02] rounded-r-lg p-6 transition-all duration-300">
            <div className="lg:col-span-7 flex flex-col justify-between">
              <div>
                ...
                <div className="mb-4">
                  <span className="text-micro text-text-tertiary font-jetbrains uppercase tracking-widest mr-2 block sm:inline mb-1 sm:mb-0">
                ...
                <p className="text-xs md:text-sm text-text-secondary font-jetbrains leading-relaxed">
                  {current.desc}
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 flex flex-col items-center justify-center bg-graphite-900/40 border border-white/5 rounded-xl p-4 min-h-[240px]">
              <div className="w-full text-micro font-jetbrains text-text-tertiary uppercase tracking-widest mb-3 flex items-center justify-between">
