...
/**
 * @fileoverview Premium 404 Error Page.
 * Uses cinematic entry animations and a data-driven aesthetic.
 */
  ...
  return (
    <main className="min-h-screen bg-[#050505] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl w-full text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/5 bg-white/[0.03] mb-8">
            <Terminal className="w-3 h-3 text-brand-primary" />
            <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-white/40">Error 404 // Path Invalid</span>
          </div>
          ...
          <p className="font-noto text-base md:text-lg text-white/50 leading-relaxed mb-12 max-w-md mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link to={-1 as any}>
              <button 
                className="flex items-center gap-2 px-8 py-4 bg-transparent text-white/40 border border-white/10 font-noto text-[11px] font-bold tracking-[0.1em] uppercase rounded-[4px] transition-all hover:bg-white/5 hover:text-white focus-ring"
        ...
        <div className="mt-20 pt-8 border-t border-white/5 flex items-center justify-center gap-4">
          <span className="font-mono text-[8px] text-white/10 uppercase tracking-[0.25em]">system.status.operational</span>
