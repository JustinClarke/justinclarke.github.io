...
export const TheCloser = () => {
  ...
  return (
    ...
    >
      <div className='flex flex-col flex-1'>
        ...
        <div className="flex flex-col gap-4 mb-4">
          <ScrollReveal direction="right" distance={12} className="flex items-center gap-6">
            <span className="font-mono text-[9px] md:text-[10px] tracking-[0.4em] uppercase text-fg/30 font-bold whitespace-nowrap">
              Contact
            </span>
          ...
          <div className='flex flex-col lg:flex-row items-center lg:items-end justify-between gap-8 sm:gap-12 lg:gap-20'>
            <ScrollReveal delay={0.1} direction="up" className='max-w-3xl'>
              <h2 className='font-noto text-4xl md:text-[clamp(28px,5vw,60px)] font-black leading-[0.95] md:leading-[1.05] tracking-tighter text-fg text-center lg:text-left'>
                ...
                <span className="text-fg/30"> driving decisions,</span><br />
            ...
            <div className='flex flex-col items-center lg:items-end gap-6 sm:gap-8 lg:gap-10 flex-shrink-0 w-full lg:w-auto'>
              ...
              <ScrollReveal once={false} delay={0.4}>
                ...
                >
                  ...
                  <div className='relative z-10 w-7 h-7 md:w-8 md:h-8 rounded-full bg-fg/[0.03] flex items-center justify-center border border-fg/10 group-hover:bg-brand-primary/10 group-hover:border-brand-primary/40 transition-all duration-500'>
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-fg/60 group-hover:text-brand-primary transition-all duration-500 group-hover:-translate-y-[2px] group-hover:translate-x-[2px]"><path d="M7 17l9.2-9.2M17 17V7H7" /></svg>
                  </div>
                </button>
              </ScrollReveal>
              ...
              <ScrollReveal once={false} delay={0.5}>
                <a
                  className='font-mono text-[13px] md:text-[14px] text-fg/50 font-bold leading-relaxed tracking-[0.08em] hover:text-brand-primary transition-colors duration-400 group relative cursor-pointer'
      ...
      >
        ...
        >
          ...
          <div className='flex flex-col'>
            <span className='font-mono text-[10px] md:text-[11px] font-bold tracking-[0.1em] uppercase text-fg/80'>JUSTIN CLARKE</span>
            <span className='font-mono text-[8px] md:text-[9px] text-fg/15 uppercase tracking-[0.25em] font-medium'>© 2026_EST</span>
          </div>
        </Link>
        ...
        <div className='flex flex-col items-center md:items-end gap-1.5'>
          <span className='font-mono text-[8px] md:text-[9px] font-bold text-fg/10 uppercase tracking-[0.3em]'>Source_Manifest</span>
          <a
            ...
            data-tooltip-pos="below"
            className='font-mono text-[12px] md:text-[14px] font-bold tracking-[0.05em] text-fg/40 hover:text-brand-primary transition-colors group'
          >
      ...
      >
        <div className='flex flex-col gap-4 font-mono text-[8.5px] md:text-[9.5px] w-full border border-fg/[0.04] bg-fg/[0.01] hover:bg-fg/[0.015] rounded-xl p-4 md:p-6 transition-all duration-300 backdrop-blur-md relative overflow-hidden group/compliance shadow-[0_4px_30px_rgba(0,0,0,0.4)]'>

          {/* Header Bar */}
          <div className='flex items-center justify-between gap-3 text-fg/30 uppercase tracking-[0.15em] font-semibold border-b border-fg/[0.04] pb-3'>
            ...
            <div className='flex items-center gap-3 text-[7px] md:text-[8px] shrink-0'>
              ...
              <span className='bg-fg/[0.03] px-2 py-0.5 rounded border border-fg/5 text-fg/20 hidden sm:inline'>VER: 2026_EST</span>
            </div>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 pt-2'>
            <div className='flex flex-col gap-2 pl-3 border-l-2 border-fg/5 hover:border-brand-primary/45 transition-colors duration-300 group/card'>
              <div className='flex items-center gap-2 text-fg/60 font-bold text-[7.5px] md:text-[8.5px] tracking-[0.08em]'>
                <span className='text-brand-primary/60 font-mono'>01_</span>
                <span>PROJECT_CLASSIFICATION</span>
              </div>
              <p className='text-fg/35 leading-relaxed font-sans text-[11px] md:text-[12px]'>
            ...
            <div className='flex flex-col gap-2 pl-3 border-l-2 border-fg/5 hover:border-brand-primary/45 transition-colors duration-300 group/card'>
              ...
              <p className='text-fg/35 leading-relaxed font-sans text-[11px] md:text-[12px] mb-1'>
          ...
          <div className='mt-2 pt-4 border-t border-fg/[0.04] flex flex-col gap-3'>
            <div className='flex flex-col gap-3 sm:flex-row sm:items-center justify-between'>
              <span className='text-fg/20 text-[7px] md:text-[8px] tracking-[0.2em] font-semibold uppercase self-start sm:self-auto'>
            ...
            {isTerminalOpen && (
              <ScrollReveal
                ...
                className='w-full border border-brand-primary/10 bg-[#060808]/95 rounded-lg p-4 font-mono text-[9px] text-fg/40 leading-relaxed shadow-inner overflow-x-auto relative scanline'
              >
                <div className='flex flex-col gap-1.5 min-w-[280px]'>
                  ...
                  <div className='text-fg/60 font-semibold'>[OK] INITIALIZING COMPLIANCE & PRIVACY AUDIT...</div>
                  <div>[OK] PROJECT STATUS: NON-COMMERCIAL / PROFESSIONAL PORTFOLIO</div>
                  <div className='flex flex-col gap-0.5 pl-3'>
                    <div className='text-fg/65'>[INFO] ASSET IDENTIFICATION SCAN:</div>
                    <div className='text-fg/50 pl-2'>
                  ...
                  <div className='flex flex-col gap-0.5 pl-3'>
                    <div className='text-fg/65'>[OK] PRIVACY PROTOCOL VALIDATION:</div>
...
const FooterSocialLink = ({
  ...
  const styles = BRAND_STYLES[label] || {
    default: 'bg-fg/[0.02] border-fg/5 text-fg/30',
