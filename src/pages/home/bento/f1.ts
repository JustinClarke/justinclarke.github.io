 ...
 * Note:    colours are tokens (var(--color-...)), not raw hex. Pure data, no
 *          logic the widget steps through these arrays on a timer, which is
 *          cheaper and more predictable than wiring real telemetry.
 */
