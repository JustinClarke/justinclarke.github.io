...
// Narrowed from the hook type so these props stay in lock-step with useF1Telemetry.
    ...
    <div className="hidden sm:flex flex-col p-2.5 md:p-3 bg-bento-panel border border-[rgba(255,255,255,0.1)] rounded-2xl shrink-0 w-full gap-2.5" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="flex items-center justify-between gap-4 select-none">
        ...
        <div className="flex-1 flex items-center gap-3">
          <span className="font-mono text-micro md:text-micro text-neutral-500 leading-none uppercase tracking-wider shrink-0">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {/* Reset: several setters at once → clean opening state (soft tyres, lap 1, full fuel). */}
          <button
            onClick={(e) => {
              e.stopPropagation();
      ...
      <div className="flex items-center justify-start">
        ...
        <div className="bg-neutral-950/80 border border-[rgba(255,255,255,0.06)] p-[3px] rounded-lg flex shrink-0">
          <button
            ...
            className={cn(
              "relative px-2 sm:px-2.5 py-[3px] rounded-[5px] font-mono text-micro md:text-micro uppercase font-bold tracking-wider transition-all duration-200",
              uiMode === 'telemetry'
