/**
 * PortfolioPage UI/UX work index.
 *
...
const CASES: CaseStudy[] = [
  {
    ...
    image: '/assets/art/crescendo/logo/logo-bg.png',
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-6 lg:p-8 justify-between relative z-10 bg-gradient-to-b from-brand-bg to-brand-bg/95">
        <div className="flex flex-col gap-3">
          <span className="font-mono text-[11px] tracking-[0.3em] uppercase font-bold text-[var(--accent)] shadow-sm">
            {study.kicker}
          </span>
          ...
          <p className="text-white/60 text-sm md:text-base leading-relaxed line-clamp-3 mt-2">
            {study.blurb}
          </p>
        </div>
        ...
        <div className="flex flex-col gap-5 mt-6">
          <div className="flex flex-wrap gap-y-4 gap-x-6 pt-5 border-t border-white/10">
            {study.meta.map((m) => (
              <div key={m.label} className="flex flex-col gap-1.5 min-w-[30%]">
                ...
                <span className="font-sans text-xs md:text-sm text-white/90 font-medium">{m.value}</span>
              </div>
            ))}
          </div>
          ...
          <div className="mt-2 inline-flex items-center justify-center gap-3 w-full px-5 py-4 rounded-xl border border-white/10 group-hover:border-[var(--accent)]/40 bg-white/[0.02] group-hover:bg-[var(--accent)]/15 transition-all duration-[1000ms] delay-75 ease-in-out shadow-inner group-hover:shadow-[0_0_20px_var(--accent-soft)]">
            <span className="font-mono text-[11px] font-bold tracking-widest uppercase text-white/70 group-hover:text-white transition-colors duration-[1000ms] delay-75 ease-in-out">
              View Case Study
            </span>
            <svg
              ...
              className="transition-all duration-[1000ms] delay-75 ease-in-out group-hover:translate-x-1.5 text-white/70 group-hover:text-[var(--accent)]"
            >
...
export const PortfolioPage = () => {
  return (
    <div className="bg-brand-bg text-white font-sans selection:bg-white/20 min-h-screen flex flex-col relative overflow-x-hidden">
      <SEO title="Studio ⋅ Justin Clarke" description="Justin Clarke UI/UX & visual design portfolio." path="/studio" />
          ...
          <div className="flex flex-col items-center xl:items-start text-center xl:text-left justify-center shrink-0">
            <ScrollReveal direction="up" distance={30}>
              <div className="flex items-center gap-4 mb-6 xl:mb-8 justify-center xl:justify-start">
                <span className="font-mono text-xs md:text-sm font-bold tracking-[0.5em] text-white/40 uppercase drop-shadow-md">Selected Work</span>
              ...
              <p className="mt-8 text-white/60 text-base md:text-lg font-medium max-w-[450px] leading-relaxed drop-shadow-sm">
